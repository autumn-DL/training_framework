...
class MNISTModule(L.LightningModule):
    ...
    def train_dataloader(self):
        ...
        train_loader = torch.utils.data.DataLoader(
            train_set, batch_size=64, shuffle=True, pin_memory=torch.cuda.is_available(), num_workers=4, persistent_workers=True
        )
    ...
    def val_dataloader(self):
        ...
        val_loader = torch.utils.data.DataLoader(
            val_set, batch_size=64, shuffle=False, pin_memory=torch.cuda.is_available(), num_workers=2, persistent_workers=True
        )
        return val_loader
